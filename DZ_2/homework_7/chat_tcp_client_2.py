...
messages_list_for_send = {"127.0.0.1:7777": "Hello, Client 1! Yes!", "127.0.0.1:9999": "Client 3, hello!"}
print("Client 2: 127.0.0.1:8888\n")

for host, mess in messages_list_for_send.items():
    try:
        send_message = requests.post(HOST_SERVER, json={"message": mess, "HOST": host, "sender": "Client 2"})
...
while True:
    try:
        accept_message = requests.post(HOST_SERVER, json={"check_mail": "", "HOST": "127.0.0.1:8888"})
